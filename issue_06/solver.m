...
plot(t,T(:,5),':r','LineWidth',2); xlabel('Time'); ylabel('Temp');
plot(t,T(:,7),'-.b','LineWidth',2); xlabel('Time'); ylabel('Temp');
plot(t,T(:,8),'--b','LineWidth',2); xlabel('Time'); ylabel('Temp');
plot(t,T(:,9),'-b','LineWidth',2); xlabel('Time'); ylabel('Temp');
plot(t,T(:,10),':b','LineWidth',2); xlabel('Time'); ylabel('Temp');
legend('N2 Stage 1','N2 Stage 2','N2 Stage 3','N2 Stage 4','He Stage 4','He Stage 3','He Stage 2','He Stage 1','location','eastoutside')
fig = gcf;
...
plot(1:mid-1,T(a,1:mid-1),'-r','LineWidth',2); xlabel('Stage'); ylabel('Temp');
plot(1:mid-1,fliplr(T(a,mid:last)),'-b','LineWidth',2); xlabel('Stage'); ylabel('Temp');
