function [data, T_a_sol, T_b_sol, T_w_sol] = RN_07_f %With temp dist, ode45, C wrappers, check q 
    clc; clear;
    close all;
    tic
    ...
    Wall_slices = 6;  % number of wall slices, -
    ...
    k_x = 40;  % wall conductance coefficient, W/K
    HX_UA_data = {'nitrogen', 4000; ...
                    'helium', 4000}; % HX coefficient, W/K
    ...
    T_w_init = 140;  % initial wall temperature, K 
    ...
    function plots 
    % HE PLOT 
    plot(1:HX_slices, T_a_sol(:, [1:5, 8:15]),'r')
    xlabel('Slices')
    ylabel('Temperature')
    title('He')
    fig = gcf;
